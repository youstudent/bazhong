            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header" style="margin-top: 10px">
                        <form id="lr_form" action="{{url('/admin/banner/record')}}" method="get">
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                    <div class="form-group field-users-select">
                                        <select id="users-select" class="form-control" name="select">
                                            ...
                                            <option {{request('select')=='banner_theme'?'selected':''}} value="banner_theme">广告主题</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <a class="btn btn-default" href="{{'/admin/banner/record'}}">重置</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-hover table-bordered text-center table-striped">
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    <td>{{$i}}</td>
                                    <td>{{$data['name']}}</td>
                                    <td>{{$data['banner_theme']}}</td>
                                    <td>{{config('language.sex')[$data['sex']]}}</td>
                                    <td>{{$data['phone']}}</td>
