        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" role="form"  action="{{url('/admin/business/categoryCreate')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" id="category_name">
                                <input type="text" name="category_name" id="category_name" class="form-control"  placeholder="请输入分类名" required>
                            </div>
                        </div>
                        <hr style="height:1px;border:none;border-top:1px dashed lavender;" />
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="category_id">
                                    @foreach($category as $value)
                                        <option {{$category_id==$value['id']?'selected':''}} value="{{$value['id']}}">{{$value['category_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
